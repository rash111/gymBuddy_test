...
export default function ExerciseDetail() {
    ...
    if (!ex) return <div className="p-6">Not found</div>;

    return (
        <div className="px-6 pt-10 pb-6">
            <Link to="/exercises" className="inline-flex items-center gap-1 text-zinc-400 hover:text-white mb-2 text-sm" data-testid="back-to-library">
